...
const std::vector<PresetEntry> s6PresetEntries = {
    ...
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsDekuTree"), RO_MQ_SET_VANILLA),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsDodongosCaveren"), RO_MQ_SET_VANILLA),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsJabuJabu"), RO_MQ_SET_VANILLA),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsForestTemple"), RO_MQ_SET_VANILLA),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsFireTemple"), RO_MQ_SET_VANILLA),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsWaterTemple"), RO_MQ_SET_VANILLA),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsSpiritTemple"), RO_MQ_SET_VANILLA),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsShadowTemple"), RO_MQ_SET_VANILLA),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsBottomOfTheWell"), RO_MQ_SET_VANILLA),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsIceCavern"), RO_MQ_SET_VANILLA),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsGTG"), RO_MQ_SET_VANILLA),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsGanonsCastle"), RO_MQ_SET_VANILLA),
...
const std::vector<PresetEntry> hellModePresetEntries = {
    ...
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsDekuTree"), RO_MQ_SET_RANDOM),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsDodongosCaveren"), RO_MQ_SET_RANDOM),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsJabuJabu"), RO_MQ_SET_RANDOM),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsForestTemple"), RO_MQ_SET_RANDOM),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsFireTemple"), RO_MQ_SET_RANDOM),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsWaterTemple"), RO_MQ_SET_RANDOM),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsSpiritTemple"), RO_MQ_SET_RANDOM),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsShadowTemple"), RO_MQ_SET_RANDOM),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsBottomOfTheWell"), RO_MQ_SET_RANDOM),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsIceCavern"), RO_MQ_SET_RANDOM),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsGTG"), RO_MQ_SET_RANDOM),
    PRESET_ENTRY_S32(CVAR_RANDOMIZER_SETTING("MQDungeonsGanonsCastle"), RO_MQ_SET_RANDOM),
