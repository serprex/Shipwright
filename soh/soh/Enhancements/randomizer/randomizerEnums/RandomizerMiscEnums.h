...
RANDO_ENUM_BEGIN(RecoilRequirements)
/* 0x00 */ RANDO_ENUM_ITEM(RECOIL_SWORD_AND_SHIELD)
/* 0x01 */ RANDO_ENUM_ITEM(RECOIL_HAMMER)
/* 0x02 */ RANDO_ENUM_ITEM(RECOIL_HAMMER_AND_SHIELD)
/* 0x03 */ RANDO_ENUM_ITEM(RECOIL_MAX)
RANDO_ENUM_END(RecoilRequirements)
