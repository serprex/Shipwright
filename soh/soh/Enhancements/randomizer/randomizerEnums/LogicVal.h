...
RANDO_ENUM_ITEM(LOGIC_SHADOW_MQ_SILVER_BLADES)
RANDO_ENUM_ITEM(LOGIC_SHADOW_MQ_SILVER_PIT)
RANDO_ENUM_ITEM(LOGIC_SHADOW_MQ_SILVER_INVISIBLE_BLADES)
RANDO_ENUM_ITEM(LOGIC_SHADOW_MQ_SILVER_SPIKES)
RANDO_ENUM_ITEM(LOGIC_SPIRIT_MQ_SILVER_LOBBY)
RANDO_ENUM_ITEM(LOGIC_SPIRIT_MQ_SILVER_BIG_WALL)
RANDO_ENUM_ITEM(LOGIC_GTG_MQ_SILVER_SLOPE)
RANDO_ENUM_ITEM(LOGIC_GTG_MQ_SILVER_LAVA)
RANDO_ENUM_ITEM(LOGIC_GTG_MQ_SILVER_WATER)
RANDO_ENUM_ITEM(LOGIC_GANONS_CASTLE_MQ_SILVER_FIRE)
