...
void RegionTable_Init_GerudoValley() {
    ...
    areaTable[RR_GV_UPPER_STREAM] = Region("GV Upper Stream", SCENE_GERUDO_VALLEY, {
        ...
        EVENT_ACCESS(LOGIC_FAIRY_ACCESS,             logic->CallGossipFairy() || (logic->IsChild && logic->Get(LOGIC_PLANT_GERUDO_VALLEY_BEAN) && logic->CanUse(RG_SONG_OF_STORMS))),
    }, {
        //Locations
        ...
        LOCATION(RC_GV_BEAN_SPROUT_FAIRY_1,    logic->IsChild && logic->Get(LOGIC_PLANT_GERUDO_VALLEY_BEAN) && logic->CanUse(RG_SONG_OF_STORMS)),
        LOCATION(RC_GV_BEAN_SPROUT_FAIRY_2,    logic->IsChild && logic->Get(LOGIC_PLANT_GERUDO_VALLEY_BEAN) && logic->CanUse(RG_SONG_OF_STORMS)),
        LOCATION(RC_GV_BEAN_SPROUT_FAIRY_3,    logic->IsChild && logic->Get(LOGIC_PLANT_GERUDO_VALLEY_BEAN) && logic->CanUse(RG_SONG_OF_STORMS)),
        ...
        LOCATION(RC_GV_WONDER_LOWER_WATERFALL, logic->IsAdult && (logic->Get(LOGIC_PLANT_GERUDO_VALLEY_BEAN) || logic->HasItem(RG_BRONZE_SCALE) || logic->CanUse(RG_IRON_BOOTS) || (ctx->GetTrickOption(RT_VOIDOUT_COLLECTION) && logic->CanVoid()))),
        LOCATION(RC_GV_WONDER_UPPER_WATERFALL, logic->IsAdult && logic->Get(LOGIC_PLANT_GERUDO_VALLEY_BEAN)),
    }, {
        //Exits
        ENTRANCE(RR_GV_UPPER_STREAM_WATER, true),
        ENTRANCE(RR_GV_WATERFALL_ALCOVE,   (logic->CanUse(RG_LONGSHOT) && (logic->HasItem(RG_CLIMB) || ctx->GetTrickOption(RT_HOOKSHOT_LADDERS))) || logic->Get(LOGIC_PLANT_GERUDO_VALLEY_BEAN)),
    });
