...
void RegionTable_Init_ZoraRiver() {
    areaTable[RR_ZR_FRONT] = Region("ZR Front", "Zora River", {RA_ZORAS_RIVER}, DAY_NIGHT_CYCLE, {}, {
        ...
        LOCATION(RC_ZR_GS_TREE, logic->IsChild && logic->BlastOrSmash()),
        LOCATION(RC_ZR_GS_TREE, logic->IsChild && logic->BlastOrSmash()),
        LOCATION(RC_ZR_GS_TREE, logic->IsChild && logic->BlastOrSmash()),
        LOCATION(RC_ZR_GS_TREE, logic->IsChild && logic->BlastOrSmash()),
    }, {
    ...
    areaTable[RR_ZORAS_RIVER] = Region("Zora River", "Zora River", {RA_ZORAS_RIVER}, DAY_NIGHT_CYCLE, {
        ...
        LOCATION(RC_ZR_ROCK_CIRCLE_1,                        true),
        LOCATION(RC_ZR_ROCK_CIRCLE_2,                        true),
        LOCATION(RC_ZR_ROCK_CIRCLE_3,                        true),
        LOCATION(RC_ZR_ROCK_CIRCLE_4,                        true),
        LOCATION(RC_ZR_ROCK_CIRCLE_5,                        true),
        LOCATION(RC_ZR_ROCK_CIRCLE_6,                        true),
        LOCATION(RC_ZR_ROCK_CIRCLE_7,                        true),
        LOCATION(RC_ZR_ROCK_CIRCLE_8,                        true),
        LOCATION(RC_ZR_UPPER_ROCK_CIRCLE_BOULDER,            logic->BlastOrSmash()),
        LOCATION(RC_ZR_UPPER_ROCK_CIRCLE_1,                  true),
        LOCATION(RC_ZR_UPPER_ROCK_CIRCLE_2,                  true),
        LOCATION(RC_ZR_UPPER_ROCK_CIRCLE_3,                  true),
        LOCATION(RC_ZR_UPPER_ROCK_CIRCLE_4,                  true),
        LOCATION(RC_ZR_UPPER_ROCK_CIRCLE_5,                  true),
        LOCATION(RC_ZR_UPPER_ROCK_CIRCLE_6,                  true),
        LOCATION(RC_ZR_UPPER_ROCK_CIRCLE_7,                  true),
        LOCATION(RC_ZR_UPPER_ROCK_CIRCLE_8,                  true),
