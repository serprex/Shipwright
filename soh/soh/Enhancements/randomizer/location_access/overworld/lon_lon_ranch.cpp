...
void RegionTable_Init_LonLonRanch() {
    areaTable[RR_LON_LON_RANCH] = Region("Lon Lon Ranch", "Lon Lon Ranch", {RA_LON_LON_RANCH}, NO_DAY_NIGHT_CYCLE, {
        ...
        LOCATION(RC_LLR_GS_HOUSE_WINDOW,     logic->IsChild && logic->CanGetNightTimeGS() && (logic->IsNNL() || logic->HookshotOrBoomerang())),
        LOCATION(RC_LLR_GS_BACK_WALL,        logic->IsChild && logic->CanGetNightTimeGS() && (logic->IsNNL() || logic->HookshotOrBoomerang())),
    ...
    areaTable[RR_LLR_TALONS_HOUSE] = Region("LLR Talons House", "LLR Talons House", {}, NO_DAY_NIGHT_CYCLE, {}, {
        ...
        //Exits
        Entrance(RR_LON_LON_RANCH, []{return logic->CanOpenOverworldDoor(RG_TALONS_HOUSE_KEY);}, true),
    });
    ...
    areaTable[RR_LLR_STABLES] = Region("LLR Stables", "LLR Stables", {}, NO_DAY_NIGHT_CYCLE, {}, {
        ...
        //Exits
        Entrance(RR_LON_LON_RANCH, []{return logic->CanOpenOverworldDoor(RG_STABLES_KEY);}, true),
    });
    ...
    areaTable[RR_LLR_TOWER] = Region("LLR Tower", "LLR Tower", {}, NO_DAY_NIGHT_CYCLE, {}, {
        ...
        //Exits
        Entrance(RR_LON_LON_RANCH, []{return logic->CanOpenOverworldDoor(RG_BACK_TOWER_KEY);}, true),
    });
