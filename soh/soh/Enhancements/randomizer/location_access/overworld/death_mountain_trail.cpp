...
void RegionTable_Init_DeathMountainTrail() {
    areaTable[RR_DEATH_MOUNTAIN_TRAIL] = Region("Death Mountain", "Death Mountain", {RA_DEATH_MOUNTAIN_TRAIL}, DAY_NIGHT_CYCLE, {
        ...
        LOCATION(RC_DMT_ROCK_CIRCLE_1,            true),
        LOCATION(RC_DMT_ROCK_CIRCLE_2,            true),
        LOCATION(RC_DMT_ROCK_CIRCLE_3,            true),
        LOCATION(RC_DMT_ROCK_CIRCLE_4,            true),
        LOCATION(RC_DMT_ROCK_CIRCLE_5,            true),
        LOCATION(RC_DMT_ROCK_CIRCLE_6,            true),
        LOCATION(RC_DMT_ROCK_CIRCLE_7,            true),
        LOCATION(RC_DMT_ROCK_CIRCLE_8,            true),
