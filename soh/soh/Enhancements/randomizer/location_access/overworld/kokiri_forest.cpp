...
void RegionTable_Init_KokiriForest() {
    areaTable[RR_KOKIRI_FOREST] = Region("Kokiri Forest", "Kokiri Forest", {RA_KOKIRI_FOREST}, NO_DAY_NIGHT_CYCLE, {
        ...
        LOCATION(RC_KF_ROCK_CIRCLE_1,           true),
        LOCATION(RC_KF_ROCK_CIRCLE_2,           true),
        LOCATION(RC_KF_ROCK_CIRCLE_3,           true),
        LOCATION(RC_KF_ROCK_CIRCLE_4,           true),
        LOCATION(RC_KF_ROCK_CIRCLE_5,           true),
        LOCATION(RC_KF_ROCK_CIRCLE_6,           true),
        LOCATION(RC_KF_ROCK_CIRCLE_7,           true),
        LOCATION(RC_KF_ROCK_CIRCLE_8,           true),
