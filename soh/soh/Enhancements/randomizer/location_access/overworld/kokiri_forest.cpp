...
void RegionTable_Init_KokiriForest() {
    ...
    areaTable[RR_KOKIRI_FOREST] = Region("Kokiri Forest", SCENE_KOKIRI_FOREST, {
        ...
        LOCATION(RC_KF_CHILD_GRASS_MAZE_1,      logic->CanUse(RG_CRAWL) && logic->CanCutShrubs()),
        LOCATION(RC_KF_CHILD_GRASS_MAZE_2,      logic->CanUse(RG_CRAWL) && logic->CanCutShrubs()),
        LOCATION(RC_KF_CHILD_GRASS_MAZE_3,      logic->CanUse(RG_CRAWL) && logic->CanCutShrubs()),
