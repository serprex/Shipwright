...
#pragma region Vanilla
    ...
    areaTable[RR_GANONS_CASTLE_WATER_TRIAL_BLOCK_ROOM] = Region("Ganon's Castle Water Trial Block Room", SCENE_INSIDE_GANONS_CASTLE, {
        ...
        EventAccess(LOGIC_WATER_TRIAL_RUSTED_SWITCH, []{return logic->HasItem(RG_POWER_BRACELET) && (logic->BlueFire() || ctx->GetTrickOption(RT_RUSTED_SWITCHES)) && logic->CanUse(RG_MEGATON_HAMMER);}),
    }, {
        //Locations
