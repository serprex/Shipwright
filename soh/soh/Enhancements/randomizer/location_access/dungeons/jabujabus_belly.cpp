...
#pragma region Vanilla
    ...
    areaTable[RR_JABU_JABUS_BELLY_BIGOCTO_LEDGE] = Region("Jabu Jabus Belly Bigocto Room", SCENE_JABU_JABU, {}, {
        ...
        //Exits
        Entrance(RR_JABU_JABUS_BELLY_B1_NORTH,      []{return true;}),
        Entrance(RR_JABU_JABUS_BELLY_ABOVE_BIGOCTO, []{return logic->Get(LOGIC_JABU_RUTO_IN_1F) && Here([]{return logic->CanKillEnemy(RE_BIG_OCTO);});}),
    });
...
#pragma region MQ
    ...
    areaTable[RR_JABU_JABUS_BELLY_MQ_HOLES_ROOM] = Region("Jabu Jabus Belly MQ Holes Room", SCENE_JABU_JABU, {}, {
        ...
        Entrance(RR_JABU_JABUS_BELLY_MQ_PAST_OCTO,            []{return logic->Get(LOGIC_JABU_WEST_TENTACLE) && Here([]{return logic->CanKillEnemy(RE_BIG_OCTO);}) && logic->CanUse(RG_FAIRY_SLINGSHOT);}),
    });
    ...
    areaTable[RR_JABU_JABUS_BELLY_MQ_FORKED_CORRIDOR] = Region("Jabu Jabus Belly MQ Forked Corridor", SCENE_JABU_JABU, {
        //Events
        EventAccess(LOGIC_JABU_NORTH_TENTACLE, []{return Here([]{return logic->BlastOrSmash();}) && logic->CanUse(RG_BOOMERANG);}),
    }, {
        //Locations
