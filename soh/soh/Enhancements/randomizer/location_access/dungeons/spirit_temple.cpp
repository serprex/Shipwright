...
#pragma region Vanilla
    ...
    areaTable[RR_SPIRIT_TEMPLE_FOYER] = Region("Spirit Temple Foyer", SCENE_SPIRIT_TEMPLE, {
        ...
        Entrance(RR_SPIRIT_TEMPLE_CHILD_SIDE_HUB,  []{return logic->IsChild && logic->HasItem(RG_SPEAK_GERUDO)/*CanUse(RG_CRAWL)*/;}),
...
#pragma region MQ
    ...
    areaTable[RR_SPIRIT_TEMPLE_MQ_FOYER] = Region("Spirit Temple MQ Lobby", SCENE_SPIRIT_TEMPLE, {
        ...
        //Exits
        Entrance(RR_SPIRIT_TEMPLE_ENTRYWAY,           []{return true;}),
        Entrance(RR_SPIRIT_TEMPLE_MQ_CHILD_SIDE_HUB,  []{return logic->IsChild && logic->HasItem(RG_SPEAK_GERUDO)/*logic->CanUse(RG_CRAWL) && logic->HasSoul(RG_NABOORU_SOUL)*/;}),
