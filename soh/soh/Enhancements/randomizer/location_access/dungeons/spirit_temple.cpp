...
#pragma region Vanilla
    ...
    areaTable[RR_SPIRIT_TEMPLE_INNER_LEFT_HAND] = Region("Spirit Temple Inner Left Hand", SCENE_SPIRIT_TEMPLE, {}, {
        ...
        //Exits
        ENTRANCE(RR_SPIRIT_TEMPLE_STATUE_ROOM,       true),
        ENTRANCE(RR_SPIRIT_TEMPLE_STATUE_ROOM_ADULT, logic->CanUse(RG_HOVER_BOOTS)/* || logic->BunnyHood()*/),
    ...
    areaTable[RR_SPIRIT_TEMPLE_STATUE_HEAD] = Region("Spirit Temple Statue Head", SCENE_SPIRIT_TEMPLE, {
        ...
        // Exits
        ENTRANCE(RR_SPIRIT_TEMPLE_STATUE_ROOM,      true),
        //Bunny hood jumps with a jumpslash can reach either hand and with good timing the platform as child. the latter is definitely a trick, the former may not be
