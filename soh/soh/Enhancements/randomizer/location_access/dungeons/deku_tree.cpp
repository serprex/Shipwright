...
#pragma region MQ
    ...
    areaTable[RR_DEKU_TREE_MQ_2F] = Region("Deku Tree MQ 2F", SCENE_DEKU_TREE, {}, {
        ...
        Entrance(RR_DEKU_TREE_MQ_EYE_TARGET_ROOM, []{return AnyAgeTime([]{return logic->HasFireSource();});}),
    });
    ...
    areaTable[RR_DEKU_TREE_MQ_3F] = Region("Deku Tree MQ 3F", SCENE_DEKU_TREE, {
        ...
        Entrance(RR_DEKU_TREE_MQ_EYE_TARGET_ROOM, []{return AnyAgeTime([]{return logic->CanUse(RG_STICKS) || logic->CanUse(RG_FAIRY_BOW);});}),
