...
#pragma region Vanilla
    ...
    areaTable[RR_DODONGOS_CAVERN_LOBBY] = Region("Dodongos Cavern Lobby", SCENE_DODONGOS_CAVERN, {
        //Events
        EventAccess(LOGIC_GOSSIP_STONE_FAIRY, []{return (Here([]{return logic->CanBreakMudWalls();}) || logic->HasItem(RG_GORONS_BRACELET)) && logic->CallGossipFairy();}),
    }, {
        //Locations
...
#pragma region MQ
    ...
    areaTable[RR_DODONGOS_CAVERN_MQ_LOBBY] = Region("Dodongos Cavern MQ Lobby", SCENE_DODONGOS_CAVERN, {}, {
        ...
        Entrance(RR_DODONGOS_CAVERN_MQ_LOWER_RIGHT_SIDE,  []{return Here([]{return logic->CanBreakMudWalls();});}),
...
#pragma endregion
    ...
    areaTable[RR_DODONGOS_CAVERN_BOSS_ROOM] = Region("Dodongos Cavern Boss Room", SCENE_DODONGOS_CAVERN_BOSS, {
        ...
        EventAccess(LOGIC_DODONGOS_CAVERN_CLEAR, []{return Here([]{return logic->HasExplosives() ||
