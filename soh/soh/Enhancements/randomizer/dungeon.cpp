...
<<<<<<< HEAD
||||||| parent of eacb65a01 (split rocks & boulders)
...
=======
    ...
    if (Context::GetInstance()->GetOption(RSK_SHUFFLE_BOULDERS).Is(RO_SHUFFLE_BOULDERS_DUNGEONS) ||
        Context::GetInstance()->GetOption(RSK_SHUFFLE_BOULDERS).Is(RO_SHUFFLE_BOULDERS_ALL)) {
        auto boulderLocations = masterQuest ? mqBoulders : vanillaBoulders;
        AddElementsToPool(locations, boulderLocations);
    }
    AddElementsToPool(locations, sharedLocations);
    AddElementsToPool(locations, bossRoomLocations);
    return locations;
...
std::vector<RandomizerCheck> DungeonInfo::GetEveryLocation() const {
    ...
    AddElementsToPool(locations, vanillaPots);
    AddElementsToPool(locations, mqPots);
    AddElementsToPool(locations, vanillaBoulders);
    AddElementsToPool(locations, mqBoulders);
    AddElementsToPool(locations, sharedLocations);
    AddElementsToPool(locations, bossRoomLocations);
>>>>>>> eacb65a01 (split rocks & boulders)
    return locations;
}
...
=======
        DungeonInfo("Deku Tree", RHT_DEKU_TREE, RG_DEKU_TREE_MAP, RG_DEKU_TREE_COMPASS, RG_NONE, RG_NONE, RG_NONE, RA_DEKU_TREE, 0, 0, RSK_MQ_DEKU_TREE,
                    ...
                    {}, {}, // Pots
                    {}, Rando::StaticData::FilterChecks(RCTYPE_BOULDER, RCQUEST_MQ, RCAREA_DEKU_TREE),
                    {},
                    {
                        // Boss Room Locations
                        RC_DEKU_TREE_QUEEN_GOHMA_HEART,
...
=======
                                               ...
                                               {}, Rando::StaticData::FilterChecks(RCTYPE_BOULDER, RCQUEST_MQ, RCAREA_DODONGOS_CAVERN),
                                               {},
                                               {
                                                   // Boss Room Locations
                                                   RC_DODONGOS_CAVERN_BOSS_ROOM_CHEST,
...
=======
                                                ...
                                                {}, Rando::StaticData::FilterChecks(RCTYPE_BOULDER, RCQUEST_MQ, RCAREA_JABU_JABUS_BELLY),
                                                {},
                                                {
                                                    // Boss Room Locations
                                                    RC_JABU_JABUS_BELLY_BARINADE_HEART,
...
=======
                    ...
                    {}, Rando::StaticData::FilterChecks(RCTYPE_BOULDER, RCQUEST_MQ, RCAREA_FOREST_TEMPLE),
                    {},
                    {
                        // Boss Room Locations
                        RC_FOREST_TEMPLE_PHANTOM_GANON_HEART,
...
=======
                    ...
                    {}, Rando::StaticData::FilterChecks(RCTYPE_BOULDER, RCQUEST_MQ, RCAREA_FIRE_TEMPLE),
                    {},
                    {
                        // Boos Room Locations
                        RC_FIRE_TEMPLE_VOLVAGIA_HEART,
...
=======
                    ...
                    {}, Rando::StaticData::FilterChecks(RCTYPE_BOULDER, RCQUEST_MQ, RCAREA_WATER_TEMPLE),
                    {},
                    {
                        // Boss Room Locations
                        RC_WATER_TEMPLE_MORPHA_HEART,
...
=======
                    ...
                    {}, Rando::StaticData::FilterChecks(RCTYPE_BOULDER, RCQUEST_MQ, RCAREA_SPIRIT_TEMPLE),
                    {
                        // Shared Locations
                        RC_SPIRIT_TEMPLE_SILVER_GAUNTLETS_CHEST,
                        RC_SPIRIT_TEMPLE_MIRROR_SHIELD_CHEST,
...
=======
                    ...
                    {}, Rando::StaticData::FilterChecks(RCTYPE_BOULDER, RCQUEST_MQ, RCAREA_SHADOW_TEMPLE),
                    {},
                    {
                        // Boss Room Locations
                        RC_SHADOW_TEMPLE_BONGO_BONGO_HEART,
...
=======
        ...
        Rando::StaticData::FilterChecks(RCTYPE_BOULDER, RCQUEST_VANILLA, RCAREA_BOTTOM_OF_THE_WELL),
        Rando::StaticData::FilterChecks(RCTYPE_BOULDER, RCQUEST_MQ, RCAREA_BOTTOM_OF_THE_WELL),
        {}, {});
>>>>>>> eacb65a01 (split rocks & boulders)
