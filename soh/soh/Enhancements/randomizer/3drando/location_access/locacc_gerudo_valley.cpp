...
void RegionTable_Init_GerudoValley() {
  ...
  areaTable[RR_GERUDO_FORTRESS] = Region("Gerudo Fortress", "Gerudo Fortress", {RA_GERUDO_FORTRESS}, NO_DAY_NIGHT_CYCLE, {
                  ...
                  LOCATION(RC_GF_NORTH_F1_CARPENTER,             logic->CanKillEnemy(RE_GERUDO)),
                  LOCATION(RC_GF_NORTH_F2_CARPENTER,             logic->CanKillEnemy(RE_GERUDO) && (logic->HasItem(RG_GERUDO_MEMBERSHIP_CARD) || logic->CanUse(RG_FAIRY_BOW) || logic->CanUse(RG_HOOKSHOT) || logic->CanUse(RG_HOVER_BOOTS) || ctx->GetTrickOption(RT_GF_KITCHEN))),
                  LOCATION(RC_GF_SOUTH_F1_CARPENTER,             logic->CanKillEnemy(RE_GERUDO)),
                  LOCATION(RC_GF_SOUTH_F2_CARPENTER,             logic->CanKillEnemy(RE_GERUDO)),
