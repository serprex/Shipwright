...
void Context::GenerateLocationPool() {
    ...
    for (Location& location : StaticData::GetLocationTable()) {
        // skip RC's that shouldn't be in the pool for any reason (i.e. settings, unsupported check type, )
        // TODO: Exclude checks for some of the older shuffles from the pool too i.e. Frog Songs, Srubs, etc.
