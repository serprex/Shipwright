...
void Settings::CreateOptions() {
    ...
    mTrickOptions[RT_ONE_SIXTEENTH_TUNIC] = TrickOption::LogicTrick(RCQUEST_BOTH, RA_NONE, {Tricks::Tag::EXTREME, Tricks::Tag::GLITCH}, "One Sixteenth Tunic", "Link is immune to tunic related timers while at 1/16th of a heart.");
