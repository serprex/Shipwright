...
void Settings::CreateOptions() {
    ...
    OPT_TRICK(RT_SFM_JUMP_ABOVE_MAZE, RCQUEST_BOTH, RA_SACRED_FOREST_MEADOW, {Tricks::Tag::INTERMEDIATE}, "Sacred Forest Meadow Jump Above Maze", "You can jump above the maze in the Sacred Forest Meadow, skipping need to kill Moblins.");
