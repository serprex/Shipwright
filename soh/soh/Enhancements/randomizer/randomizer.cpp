...
std::map<RandomizerCheck, RandomizerInf> rcToRandomizerInf = {
    ...
    { RC_KF_ROCK,RAND_INF_KF_ROCK },
    { RC_LW_BOULDER_1,RAND_INF_LW_BOULDER_1 },
    { RC_LW_BOULDER_2,RAND_INF_LW_BOULDER_2 },
    ...
    // TODO figure out which of these 2 can be detonated with stick trick
